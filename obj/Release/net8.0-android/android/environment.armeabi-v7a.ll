...
@dso_cache = dso_local local_unnamed_addr global [994 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 563041045, ; hash 0x218f5315, from name: aot-FWSAPP
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1128626112, ; hash 0x434577c0, from name: FWSAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FWSAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 1563497488, ; hash 0x5d311410, from name: libaot-FWSAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FWSAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 335
	...
	%struct.DSOCacheEntry {
		i64 1922045373, ; hash 0x729015bd, from name: FWSAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FWSAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 426
	...
	%struct.DSOCacheEntry {
		i64 2022330035, ; hash 0x788a4eb3, from name: aot-FWSAPP.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FWSAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 451
	...
	%struct.DSOCacheEntry {
		i64 2982538662, ; hash 0xb1c5eda6, from name: libaot-FWSAPP
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-FWSAPP.dll.so
		ptr null; void* handle (0x0)
	}, ; 683
